...
public class BybitExchange extends BaseExchange {
  ...
  public void applySpecification(ExchangeSpecification exchangeSpecification) {
    ...
    if (exchangeSpecification
        .getExchangeSpecificParametersItem(SPECIFIC_PARAM_TESTNET) != null &&
        exchangeSpecification
            .getExchangeSpecificParametersItem(SPECIFIC_PARAM_TESTNET).equals(true)) {
